...
npc1_image = pygame.image.load('Sprites/personagens/Isac/Isac.png').convert_alpha()
npc2_image = pygame.image.load('Sprites/personagens/Isac/Isac.png').convert_alpha()
npc3_image = pygame.image.load('Sprites/personagens/Isac/Isac.png').convert_alpha()
...
# Instanciar os NPCs
npc1 = NPC(npc1_image, (450, 470), camera_group)
npc2 = NPC(npc2_image, (800, 220), camera_group)
npc3 = NPC(npc3_image, (1000, 600), camera_group)
